...
RSpec.describe Project do
  before(:each) do
      ...
      @project2 = Project.new('Project 2', 'description 2', 'Jane Doe') # create a new project and make sure we can set the name attribute
  end
  ...
  it 'has a getter and setter for name attribute' do
      ...
      expect(@project1.owenr).to eq("Another Owner")
  end
